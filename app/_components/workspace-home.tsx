  ...
  return <main id="main-content" className="experience-shell" tabIndex={-1}>
    ...
    {!result ? <div className="intake-experience">
      ...
      {activeStage === 'documents' ? <section className="stage-surface documents-stage">
        ...
        {openQuestions.length ? <p className="experience-notice project-notice blocking" role="status">Answer all clarification questions to unlock document review and approval. Each answer regenerates Requirements, SRS, NFR, and HLD from the same graph version.</p> : null}
      ...
      {activeStage === 'wireflow' ? <section className="stage-surface wireflow-stage">
        ...
        <TemplateGallery selected={selectedTemplateId} onSelect={setSelectedTemplateId} context={{ projectName, entities: result.entities, gaps: result.gaps }} />
