...
This folder is the implementation contract for the Axiom hackathon MVP.

## Files

- `SRS.md`: complete product and technical requirements
...
Axiom converts ambiguous business intent into approved engineering decisions, enterprise artifacts, controlled implementation, real verification evidence, and grounded Why / Why Not / Proof answers.
